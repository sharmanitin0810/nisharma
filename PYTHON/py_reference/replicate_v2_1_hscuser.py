...
UT_REMOTE_DIR = '/home/nomad/defaultEphemeris/'
UT_HOST_MACHINE = '192.168.1.140'
UT_PORT = 22
UT_USERNAME = 'nomad'
UT_PASSWORD = 'admin1234'
...
def printme(fname):
    print "Downloading %s file " %(fname)
...
def main():
    while 1:
        print (" Script Started .. replicate_v2_1 ...")
        dirReplicator = DirectoryReplicator(EPH_HOST_MACHINE, 22, USERNAME, PASSWORD, REMOTE_DIR)
        dirReplicator.Replicate(callback=printme)
